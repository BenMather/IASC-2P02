...
const animation = () =>
{
    ...
    {
        const targetY = 8
        torusKnot.position.y += (targetY - torusKnot.position.y) * 0.01
        capsule.position.y += ((targetY - capsule.position.y) - 2 ) * 0.02
    }
    ...
    {
        torusKnot.position.z = Math.tan(elapsedTime)
        capsule.position.z = Math.tan(elapsedTime) + 2
    }
